import { StyleSheet, Text, View, SafeAreaView, StatusBar, KeyboardAvoidingView, Image, TextInput, TouchableOpacity } from 'react-native'
            ...
            <KeyboardAvoidingView behavior='padding' style={styles.login_project}>
                ...
                <View style={styles.login_fpt}>
                    <View style={styles.login_fpoly}>
                        ...
                        <View style={styles.login_projectpoly}>
                            <View style={styles.login_fsoftimg}>
                                <Image source={{ uri: 'https://cdn-icons-png.flaticon.com/128/11502/11502423.png' }} style={styles.login_polyimg}></Image>
                            </View>
                            <TextInput style={styles.login_input}
                                placeholder='Email'
                                placeholderTextColor='rgba(0, 0, 0, 0.1)'
                        ...
                        <View style={styles.login_projectpoly}>
                            <View style={styles.login_fsoftimg}>
                                <Image source={{ uri: 'https://cdn-icons-png.flaticon.com/128/3178/3178167.png' }} style={styles.login_polyimg}></Image>
                            </View>
                            <TextInput style={styles.login_input}
                                placeholder='Phone'
                                placeholderTextColor='rgba(0, 0, 0, 0.1)'
                    ...
                    <View style={styles.login_register}>
                        <Text style={styles.login_fsoft}>Bạn đã có tài khoản ?</Text>
                        <TouchableOpacity onPress={handleLogin}>
                            <Text style={styles.login_movie}>Login</Text>
                        </TouchableOpacity>
                    </View>
                </View>
